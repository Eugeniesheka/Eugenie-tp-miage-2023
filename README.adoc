...
*R/ Oui le code est structuré en couche parce que nous pouvons clairement voir une séparation applicative .Certaines couches sont melangées entre elles ce qui pose un probleme de maintenabilité et d'evolutivité  *
*Où se trouve le code métier (voir la règle de gestion RG 1) ?*
*R/ le code metier se trouve dans la classe TodoListController*
